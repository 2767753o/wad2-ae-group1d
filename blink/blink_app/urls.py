...
urlpatterns = [
        ...
        path('post/<int:post_id>/likes', views.view_likes_post, name='view_likes_post'),
        ...
        path('comment/<int:comment_id>/likes', views.view_likes_comment, name='view_likes_comment'),
        path('search/', views.SearchView.as_view(), name='search'),
        path('create/', views.create, name='create'),
        path('about/', views.about, name='about'),
        path('help/', views.help, name='help'),
        path('user/<slug:username_slug>/', views.view_user, name='user'),
        ...
        # path('user/<id:userId>/followed', views.user_follblink:owed_by, name='user_followed_by'),
